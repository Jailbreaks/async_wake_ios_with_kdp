...
uint64_t ksymbols_iphone_7_15B202[] = {
  ...
  0xfffffff00701d97c, // KSYMBOL_VERSION_STRING
  0xfffffff0075ec8c8, // KSYMBOL_KERNEL_UUID_STRING
  0xFFFFFFF0071E1668, // KSYMBOL_ARM_DEBUG_SET
  0xFFFFFFF00713C01C, // KSYMBOL_ZONE_GC
  0xFFFFFFF0071DE5E0, // KSYMBOL_EL1_SW_STEP_INFINITE_LOOP
};
...
uint64_t ksymbols_ipod_touch_6g_15b202[] = {
  ...
  0xFFFFFFF00702D75C, // KSYMBOL_VERSION_STRING            // find the ASCII string named version
  0xFFFFFFF0075B88C8, // KSYMBOL_KERNEL_UUID_STRING        // look for xrefs to "assertions", find the one preceeded by the call to uuid_unparse_upper, second arg to that is kernel_uuid_string
  0xFFFFFFF0071AC9AC, // KSYMBOL_ARM_DEBUG_SET             // look for writes to the hw debug registers (eg DBGBVR15_EL1)
  0xFFFFFFF007100DE0, // KSYMBOL_ZONE_GC                   // only necessary if you want to force GC for testing exploits
  0xFFFFFFF0071A963C, // KSYMBOL_EL1_SW_STEP_INFINITE_LOOP // look for the xref to "Unsupported synchronous exception." and find the infinite loop in switch case 51
};
...
uint64_t ksymbols_iphone_6s_15b202[] = {
  ...
  0x4848484848484848, // KSYMBOL_ZONE_GC
...
void offsets_init() {
  ...
  if (strstr(u.machine, "iPod7,1")) {
    ...
    printf("tfp0 should still work, but the kernel debugger won't\n");
    symbols = NULL;
    have_syms = 0;
  }
}
